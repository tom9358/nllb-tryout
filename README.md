...
It was trained on about 13.000 Gronings-Dutch sentence pairs from [Tatoeba](https://tatoeba.org/), a bit over half of which I wrote myself. In addition to this, I'm looking into using synthetic data. This research is still ongoing, and has produced promising results. The demo model at HF Spaces already makes use of such data.
...
Special thanks to [CmdCody](https://huggingface.co/CmdCody/) for the very similar inspirational project for North Frisian, and for the link to a useful blogpost.
